...
public class StatsCommand extends Command {
    ...
    public String getDescription() {
        return "Displays information about Savitar and some related stats.";
    }
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        context.makeEmbeddedMessage(MessageType.INFO,
            new MessageEmbed.Field(context.i18n("fields.author"), "[Steus#0001]", true),
            new MessageEmbed.Field(context.i18n("fields.website"),"[bot.savitar.gq](https://bot.savitar.gq)", true),
            ...
            .setTitle(context.i18n("title"), "https://discord.gg/WbdGDYg")
            .setAuthor("AvaIre v" + AppInfo.getAppInfo().version, "https://discord.gg/WbdGDYg", avaire.getSelfUser().getEffectiveAvatarUrl())
