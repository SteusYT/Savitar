...
public class UserInfoCommand extends Command {
    ...
    public String getDescription() {
        return "Shows information about the user that ran the command, or the mentioned user. This includes the users username, ID, roles, the date they joined the server, the date they created their account, and how many servers they're in (That Savitar knows about).";
    }
